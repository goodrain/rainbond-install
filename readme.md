[![Docs](https://img.shields.io/badge/docs-v3.6.1-brightgreen.svg)](https://www.rainbond.com/docs/stable/getting-started/pre-install.html)[![Build Status](https://travis-ci.org/goodrain/rainbond-install.svg?branch=master)](https://travis-ci.org/goodrain/rainbond-install)
...
- Calico v2.4.1
- Etcd v3.2.13
- [Rainbond Core Plugins v3.6.1](https://github.com/goodrain/rainbond)
- [Rainbond UI v3.6.1](https://github.com/goodrain/rainbond-ui)
- Salt v2017.7.5
