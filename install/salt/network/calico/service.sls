...
pull-calico-image:
  cmd.run:
    - name: docker pull {{ pillar.network.compute.get('image', 'goodrain.me/calico-node:v2.4.1') }}
    - unless: docker inspect {{ pillar.network.compute.get('image', 'goodrain.me/calico-node:v2.4.1') }}
{% endif %}
